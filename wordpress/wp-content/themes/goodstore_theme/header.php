...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?> > <!--<![endif]-->
    ...
    <body <?php body_class($rtl . " " . jwOpt::get_option('theme_style', 'fullwidth') . " " . $top_bar_fix . " " . $wide_class . " " . $menu_class_str . " " . jwOpt::get_option('hide_sliders', 'hide-sliders')); ?>   itemtype="http://schema.org/Review" itemscope  >
            ...
            <div id="container" class="container" role="document">
                ...
                <div id="template-box">
                    ...
                    <div id="header">
                        <div class="row-fullwidth">
                            <?php
                            if (jwOpt::get_option('header_style', 'header-small-444') == 'header-small-444') {
                                echo jaw_get_template_part('header-small-444', 'header');
                            } else if (jwOpt::get_option('header_style', 'header-small-48') == 'header-small-48') {
                                echo jaw_get_template_part('header-small-48', 'header');
                            } else if (jwOpt::get_option('header_style', 'header-small-84') == 'header-small-84') {
                                echo jaw_get_template_part('header-small-84', 'header');
                            } else if (jwOpt::get_option('header_style', 'header-small-66') == 'header-small-66') {
                                echo jaw_get_template_part('header-small-66', 'header');
                            } else if (jwOpt::get_option('header_style', 'header-big') == 'header-big') {
                                echo jaw_get_template_part('header-big', 'header');
                            } else {
                                echo jaw_get_template_part('header-small-center', 'header');
                            }
                            ?>
                        </div>
                        <?php
                    ...
                    <div id="main" class="row">                                                
                        ...
                        if (jwOpt::get_option('blog_featured_show', 'off') != 'off') {
                            if (jwOpt::get_option('blog_featured_show', 'off') == 'homepage' && is_home()) {
