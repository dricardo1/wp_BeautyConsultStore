...
<?php } ?>
    ...
    !function(a, b, c) {
        ...
        a.getElementById(c) || (d = a.createElement(b), d.id = c, d.src = "//connect.facebook.net/<?php echo jwOpt::get_option('social_comments_language', "en_GB"); ?>/all.js#xfbml=1", e.parentNode.insertBefore(d, e))
