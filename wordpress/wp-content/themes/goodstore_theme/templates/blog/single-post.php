...
while (have_posts()) : the_post();
    ...
    ?>
    <article  <?php post_class($layout . ' ' . 'content' . ' ' . implode(' ', jwLayout::content_width())) ?> id="post-<?php the_ID(); ?>" <?php if ($review) { ?> itemscope itemtype="http://data-vocabulary.org/Review" <?php } ?> >
        <!-- Image / video / gallery -->
        <?php
