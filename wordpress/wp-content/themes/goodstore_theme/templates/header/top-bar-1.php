...
if(jwOpt::get_option('top_bar_login_button', '0') == '0' 
        && jwOpt::get_option('top_bar_wishllist', '1') == '0' 
        && jwOpt::get_option('top_bar_cart', 'off') == 'off'
        && jwOpt::get_option('top_bar_search', '1') == '0'){
