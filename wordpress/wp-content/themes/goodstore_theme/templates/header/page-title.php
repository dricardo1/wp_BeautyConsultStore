...
} else if (((function_exists('is_product') && function_exists('is_product_category')  && function_exists('is_product_tag') && (is_product_tag() || is_product_category() || is_product())) && jwOpt::get_option('woo_breadcrumbs', '1') == '1') 
