...
?>
<article id="post-<?php the_ID(); ?>"  <?php post_class(array('element', $class, $content_width['desktop'], 'content-classical', 'format-video')); ?>   
         ...
         sort_category="<?php echo (isset($terms[0]->slug)) ? $terms[0]->slug : '' ?>">
    <div class="box ">
        <div class="image">
            <?php
