...
$options[] = array("name" => "Google Ads Code",
    "desc" => "Insert the Google Ads Code. <b>Notice: You may have maximally 3 google ads on one page.</b>",
...
$options[] = array(
    ...
    "file" => array("demo1", 'demo2', 'demo3', 'demo4'),
    "description" => array("Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>", "Click the thumbnail to make your site look like our demo.<br /><b>Please read carefully the Warning above before you select this option.</b>"),
    "img" => array("demo1.jpg", "demo2.jpg", "demo3.jpg", "demo4.jpg"), //in /demo/images folder
    "type" => "importpreset"
);
...
$options[] = array(
    ...
    'desc' => 'Insert your Facebook App ID to be able to share your site and to do a Facebook commentary. For more information please visit <a href="https://developers.facebook.com">developers.facebook.com</a>.',
    'std' => "",
);
...
$options[] = array(
    ...
    'type' => 'button',
    'name' => 'FB Comment Moderation Area',
    'desc' => "If you are a moderator you will see notifications within facebook.com. If you don't want to have moderator status or want to see all comments in one area, use the Comment Moderation Area link.",
    'std' => '1',
...
$options[] = array(
    ...
    'std' => '0',
    'mod' => 'small',
    'options' => array("0" => "Light", "1" => "Color", "2" => "Boxed", '10' => 'Small')
);
