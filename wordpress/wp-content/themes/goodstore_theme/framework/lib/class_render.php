    ...
    class jwRender {
        ...
        public static function pagination($styl = 'number', $query = null, $mid_size = 3) {
            ...
            $infinity_script = '  
                    ...
                    infinite_scroll.push({  
                        ...
                        itemSelector: ".jaw_paginated_' . jaw_template_get_counter('pagination') . ' article.element",
        ...
        public static function get_video_player($url, $width) {
            ...
            if ($video->domain == 'youtube') {
                $out .= '<iframe  class="video" itemscope itemtype="http://schema.org/VideoObject" width="100%" height="' . $height . '" src="http://www.youtube.com/embed/' . $video->id . '" frameborder="0" allowfullscreen>
                ...
                $out .= '<iframe class="video" itemscope itemtype="http://schema.org/VideoObject" src="http://player.vimeo.com/video/' . $video->id . '" width="100%" height="' . $height . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen>
                    <meta itemprop="thumbnailUrl" content="' . $video->thumbnails['thumbnail_medium'] . '" />
