...
// only for metabox layout + sidebars_delect 
        ...
        public static function element_ajax_multidropdown($value, $data = null) {
            ...
            $class = $class ? ' class="' . implode(' ', $class) . ' chosen"' : '';
        ...
        public static function element_range($value, $data = null) {
            ...
            $output.= '<input type="number" name="' . $value['id'] . '" id="' . self::convert($value['id']) . '"  class="regular-text" value="{{edit[\'' . $value['id'] . '\']}}" ng-model="edit[\'' . $value['id'] . '\']" />';
