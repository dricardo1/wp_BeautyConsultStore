...
if (!class_exists('jwBuilder')) {
    ...
    class jwBuilder {
        ...
        public static function jw_pb_print($content) {
            ...
            if (get_post_meta(get_the_ID(), 'jaw_pb_startup', true) == 'true' && get_post_meta(get_the_ID(),'_wpb_vc_js_status',true) != 'true') {
                ...
                $out = '';
                $out .= '<div class="builder-section">';
                $out .= '<div class="row">';
                $out .= '<div class="classic-page-content ' . implode(' ', jwLayout::content_width()) . '">';
