    ...
    class jwBuilderHelper {
        ...
        public function jaw_builder_editor() {
            ...
            <div id="jaw-builder-popup"   >
                <?php
                if (isset($jaw_builder_options[$_GET['code']])) {
                    ?>

                    <div id="header_editor"  >
                        <span><?php echo ucfirst(str_replace('_', ' ', $_GET['code'])); ?></span>
                    ...
                    <div id="editor_container" >
                        ...
                        <div class="content"  >
                            <?php
                            echo jwElements::elements_render($jaw_builder_options[$_GET['code']]);
                            //load_template('editor-dialogs/' . $_GET['code'] . '.php');
                            ?>
                        </div>
                    </div>
                ...
                <?php } else { ?>
                    ...
                    Something wrong happened. Dialog (<?php echo $_GET['code']; ?>) couldn't be loaded.
