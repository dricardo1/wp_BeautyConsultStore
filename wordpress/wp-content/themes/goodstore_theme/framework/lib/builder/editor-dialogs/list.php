...
$of_options[] = array(
    ...
    'type' => 'text',
    'name' => 'Bullet Icon',
    'desc' => 'Open this <a href="' . THEME_URI . '/help/icons/icons.html?amp;TB_iframe=true" class="thickbox" target="_blank">list of classes</a>, choose the bullet icon you prefer and copy/paste or write down its class name to this field.',
