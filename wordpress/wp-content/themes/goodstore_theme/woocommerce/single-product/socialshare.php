...
<ul class="socialshare-icon">
    ...
    <li>
        <a class="link-email" target="_blank" href="mailto:youremail@addresshere.com?subject=<?php echo urldecode($title); ?>&body=<?php echo strip_tags(urldecode($desc)) . ' Link: ' . $link; ?>">
